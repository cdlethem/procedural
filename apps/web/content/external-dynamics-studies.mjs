/** Original Canvas2D studies backed by the source-reviewed dynamics operations. */
export const externalDynamicsStudies=[
  {slug:'lingering-links',category:'Motion',operations:['radius-pairs-2d','contact-history-2d']},
  {slug:'sensing-trails',category:'Motion',operations:['sensor-motor-step-2d']},
  {slug:'flocking-marks',category:'Motion',operations:['flock-steer-2d']},
