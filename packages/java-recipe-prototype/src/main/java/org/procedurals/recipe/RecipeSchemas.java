...
final class RecipeSchemas {
    ...
    static Object query(String id, String port) {
        ...
        if ("layout.regular-grid".equals(id) || "field.gradient-noise-2d-01".equals(id) || "color.cyclic-palette".equals(id) || "path.gradient-trace-2d".equals(id) || "sampling.seeded-circle-placement-2d".equals(id)) {
            String key = id + "\u0000" + port;
            switch (key) {
