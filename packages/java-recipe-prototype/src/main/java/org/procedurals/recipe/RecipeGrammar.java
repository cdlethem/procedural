...
final class RecipeGrammar {
    ...
    static final String BINDINGS_SHA256 = "e523fc56f62719f7a789957c80179a9091a5b77871aba57113067aa63847c6bc";
    ...
    private static final Map<String,String> DECLARATIONS = freezeMap(map("layout.regular-grid","0.1.0","field.gradient-noise-2d-01","0.1.0","color.cyclic-palette","0.1.0","path.gradient-trace-2d","0.1.0","sampling.seeded-circle-placement-2d","0.1.0"));
    private static final Map<String,Set<String>> PORTS = freezePorts(map("layout.regular-grid",set("point"),"field.gradient-noise-2d-01",set("sample"),"color.cyclic-palette",set("sample"),"path.gradient-trace-2d",set(),"sampling.seeded-circle-placement-2d",set()));
