...
final class RecipeGrammar {
    ...
    static final String BINDINGS_SHA256 = "b405416b141e1373383e69c257100741f5767b531845c13c0e75b5f355338b14";
    ...
    private static final Map<String,String> DECLARATIONS = freezeMap(map("layout.regular-grid","0.1.0","field.gradient-noise-2d-01","0.1.0","color.cyclic-palette","0.1.0","path.gradient-trace-2d","0.1.0","sampling.seeded-circle-placement-2d","0.1.0","layout.seeded-quadrant-partition-2d","0.1.0"));
    private static final Map<String,Set<String>> PORTS = freezePorts(map("layout.regular-grid",set("point"),"field.gradient-noise-2d-01",set("sample"),"color.cyclic-palette",set("sample"),"path.gradient-trace-2d",set(),"sampling.seeded-circle-placement-2d",set(),"layout.seeded-quadrant-partition-2d",set()));
