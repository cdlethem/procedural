...
The drawing calls [geometry.simplify-polyline-2d](../../../catalog/operations/simplify-polyline-2d.json) through `simplifyPolyline2D`. This README describes an editable example only; it makes no native-support claim.
