...
Status: Java implementation and native validation are in progress. This guide describes
the starter in the worktree; a validated installable PlacementMarks package is not yet
available. JavaScript, Python and Android delivery is deferred to the porting batch.
