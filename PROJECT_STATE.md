...
measured interface (worst cold-cache key change 1.0s, main thread responsive). The
remaining delivery-table work is the later I families and the deeper-audit gaps.
