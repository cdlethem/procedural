...
Ports of these newer workflows to JavaScript, py5 and Android are deferred. The local Java 0.19.0 source bundle
contains all nineteen starters and nineteen reusable operations. It is not a published registry
...
The accepted local archive is identified in [the Java0.19 review](evidence/distribution/cp16-java-review.json).
...
[Build and install Java 0.19.0](docs/building-java-from-source.md) for all nineteen starters.
