...
existing gallery and new work. The current corrective audit precedes expansion releases.
...
mechanism better. Keep useful fixed compositions as examples. Preserve URLs and saved
work when revising or consolidating entries.
...
Compare with a relevant strong existing study and representative corpus images. Examine
mechanisms and degrees of freedom, not resemblance alone. Keep provenance and acceptance
bookkeeping out of teaching copy.
...
3. Do the images demonstrate the mechanism and a useful range of outcomes?
...
Control-schema changes require saved-work migration and review of old parameter meanings.
Guides and generated metadata must agree with the UI. Preserve both redesigns. Build fresh
releases with preview assets and service configuration, then verify the actual live URL.
...
2. Redesign ornament poster and geometric panel; redesign embossed field and signed edge
   ...
   other shallow families in the audit rather than stopping at the four named examples.
3. Reopen the pending dynamics gallery batch's creative review, including slow cold growth
   replays. Preserve its implementation and technical evidence.
4. Release reviewed improvements, then resume the full capability plan under this process.
