...
support is **64 conformant JavaScript cores, 64 operations with scoped native coverage, and
...
30 p5-only computations and 60 original studies. There are now 103 package workflows and
90 web gallery/Studio studies. The new three operations do not claim Java or other-port support, and the
studies do not add surveyed-original recreation or technique-attestation counts.
