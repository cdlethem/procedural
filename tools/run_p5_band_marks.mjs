...
import {startBandMarksServer} from './serve_band_marks.mjs';
...
const server=await startBandMarksServer(0);let browser;
const out=path.resolve(process.argv[2] || '.work/port-band-native');
assert.ok(out.startsWith(path.join(root,'.work')+path.sep));await fs.mkdir(out);
const sources=['packages/javascript/src/internal/drawing.js','packages/javascript/src/gradient-noise-2d-01.js','packages/javascript/src/internal/noise-hash.js','packages/javascript/src/internal/drawing-state.js','packages/javascript/src/cyclic-palette.js','packages/javascript/src/fdlibm-trig.js','packages/javascript/src/internal/p5-frame.js','packages/javascript/src/noise-band-path.js','packages/javascript/examples/band-marks/sketch.js','packages/javascript/examples/band-marks/band-marks.js','packages/javascript/examples/band-marks/index.html','tools/serve_band_marks.mjs','tools/run_p5_band_marks.mjs'];
